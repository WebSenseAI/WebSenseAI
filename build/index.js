 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const i$1=(i,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(n){n.createProperty(e.key,i);}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this));},finisher(n){n.createProperty(e.key,i);}},e$3=(i,e,n)=>{e.constructor.createProperty(n,i);};function n$3(n){return (t,o)=>void 0!==o?e$3(n,t,o):i$1(n,t)}
...
const SERVER_URL = location.hostname === "localhost" ? "http://localhost:5000" : "https://websense-backend-production.up.railway.app";

class ChatPopup extends s$1 {
    togglePopup() {
        this.isPopupOpen = !this.isPopupOpen;
    }
    async sendMessage(questions, key) {
        // Messagge sende to the server add animation of thinking
        const result = await axios$1.get(`${SERVER_URL}/api/response/get/${key}`, {
            params: {
                question: questions
            }
        });
...
__decorate([
    n$3({ type: Boolean }) // Declare isPopupOpen as a property
], ChatPopup.prototype, "isPopupOpen", void 0);
__decorate([
    n$3({ type: String }) // Declare isPopupOpen as a property
...
class ChatHeader extends s$1 {
    constructor() {
        super();
        this.header = "";
        this.description = "A live chat interface, here to help you get to know our blog better, in a funny way! 😄";
...
__decorate([
    n$3({ type: String })
], ChatHeader.prototype, "header", void 0);
__decorate([
    n$3({ type: String })
], ChatHeader.prototype, "description", void 0);
...
class ChatBubbleTyping extends s$1 {
    render() {
        return x `
         <div class="is-typing">
            <div class="jump1"></div>
...
class ChatInput extends s$1 {
    ...
    render() {
      ...
      <div class="chat-input">
        <input class="chat-input--input" type="text" placeholder="Reply..."  ${n(this.inputChatRef)} @keydown=${this.handleKeyPress}>
        <button @click="${this.handleClick}" class="chat-input--button">></button>
      </div>
    `;
    }
}
ChatInput.styles = i$3 `
    .chat-input {
        width: 100%;
        box-sizing: border-box;
        display: flex;
...
class WebSense extends s$1 {
    ...
    /* Fetch info */
    async firstUpdated() {
        const response = await axios$1.get(`${SERVER_URL}/api/info/bot/${this.id}`); // Add the URL of the backend
